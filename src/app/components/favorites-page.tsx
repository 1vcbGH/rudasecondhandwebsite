...
// Productos completos (debe coincidir con catalog-page)
const allProducts = [
  {
    id: 1,
...
export function FavoritesPage({ favorites, onProductClick, toggleFavorite }: FavoritesPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl mb-2">Mis Favoritos</h1>
        ...
        {favoriteProducts.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20">
            <Heart className="size-16 text-neutral-300 mb-4" />
            ...
            {favoriteProducts.map((product) => (
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden rounded-lg mb-3 bg-neutral-100">
                  ...
                  />
                  <button 
                    className="absolute top-3 right-3 size-9 rounded-full bg-white/90 flex items-center justify-center opacity-100 hover:bg-white transition-opacity"
                    onClick={(e) => {
                      e.stopPropagation();
